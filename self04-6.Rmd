...
subtitle: "Неделя 4. (6) **ММЛР:** оценивание МНК (II)"
...
---
class: animated, fadeIn
## Решение **выборочного аналога** задачи ММЛР

$$\hat\beta=\arg\min_{b}\frac{1}{n}\sum_{i=1}^n(y_i-x_i'b)^2 \tag{4.2}$$
--

### Оценка МНК параметров ММЛР
